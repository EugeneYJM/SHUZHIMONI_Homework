...
%                 imagesc((1:Nx)*dx*1.e-3,(1:Nx)*dx*1.e-3,eta');
        ...
        if niter == 0
            imwrite(imind,cm,'assignment2_6_nonlinear-HN-eq3-5-1a.gif','gif', 'Loopcount',inf);
        else
            imwrite(imind,cm,'assignment2_6_nonlinear-HN-eq3-5-1a.gif','gif','WriteMode','append');
        end

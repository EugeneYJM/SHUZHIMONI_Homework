...
%         zlabel('\eta, m')
        ...
        if niter == 0
            imwrite(imind,cm,'assignment2_6_nonlinear-HN-eq3-5-1b.gif','gif', 'Loopcount',inf);
        else
            imwrite(imind,cm,'assignment2_6_nonlinear-HN-eq3-5-1b.gif','gif','WriteMode','append');
        end
